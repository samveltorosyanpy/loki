...
min_limits_amount_exchange = {
    "AMD": float(Sessions.query(ChangeInformation.min_limits_amount_exchange_amd).filter(ChangeInformation.id == 1)[0][0]),
    "USD": float(Sessions.query(ChangeInformation.min_limits_amount_exchange_usd).filter(ChangeInformation.id == 1)[0][0]),
    "BTC": float(Sessions.query(ChangeInformation.min_limits_amount_exchange_btc).filter(ChangeInformation.id == 1)[0][0]),
    "DASH": float(Sessions.query(ChangeInformation.min_limits_amount_exchange_dash).filter(ChangeInformation.id == 1)[0][0]),
    "XRP": float(Sessions.query(ChangeInformation.min_limits_amount_exchange_xrp).filter(ChangeInformation.id == 1)[0][0]),
    "LTC": float(Sessions.query(ChangeInformation.min_limits_amount_exchange_ltc).filter(ChangeInformation.id == 1)[0][0]),
}

max_limits_amount_exchange = {
    "AMD": float(Sessions.query(ChangeInformation.max_limits_amount_exchange_amd).filter(ChangeInformation.id == 1)[0][0]),
    "USD": float(Sessions.query(ChangeInformation.max_limits_amount_exchange_usd).filter(ChangeInformation.id == 1)[0][0]),
    "BTC": float(Sessions.query(ChangeInformation.max_limits_amount_exchange_btc).filter(ChangeInformation.id == 1)[0][0]),
    "DASH": float(Sessions.query(ChangeInformation.max_limits_amount_exchange_dash).filter(ChangeInformation.id == 1)[0][0]),
    "XRP": float(Sessions.query(ChangeInformation.max_limits_amount_exchange_xrp).filter(ChangeInformation.id == 1)[0][0]),
    "LTC": float(Sessions.query(ChangeInformation.max_limits_amount_exchange_ltc).filter(ChangeInformation.id == 1)[0][0]),
}
